...
--•	The result should include only sales shipment transactions (transaction type 5) for the year 2012.
--•	The materialized view should not contain subtotals that are created by the CUBE and the ROLLUP keywords.
--•	To make the peer assessment easier, you should name your materialized view “SalesByVendorDateKeyMV2012”.
...
WHERE TRANSTYPEKEY = 5 AND CALYEAR = 2012 
